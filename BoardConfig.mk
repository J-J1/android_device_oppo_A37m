...
# Bootloader"
TARGET_BOOTLOADER_BOARD_NAME := 1472669922

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 12505088 # This is the maximum known partition size, but it can be higher, so we just omit it
